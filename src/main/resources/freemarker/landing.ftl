...
<html lang="en" class="no-js">
	...
	<body style="background:url(http://filmmakeriq.com/wp-content/uploads/2013/11/Popcorn-Slate1.jpg);">
		<div class="container">
			  ...
			  <div class="row row-offcanvas row-offcanvas-right">
				<div>
				  <p class="pull-right visible-xs">
					...
					<a href="/moviebuddy/v1/home">
					 <img src="http://www.yfs.ymca.org/lib-local/assets/Special%20Events/movie.png" width="150" style="display:block;margin-left:auto;margin-right:auto;">
					</a>
				</div><!--/span-->   
			  </div><!--/row-->
		<!--      <hr>  -->
